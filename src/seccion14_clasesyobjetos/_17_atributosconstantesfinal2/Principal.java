package seccion14_clasesyobjetos._17_atributosconstantesfinal2;
...
public class Principal {
    public static void main(String[] args) {
        ...
        auto1.setColor(Automovil.COLOR_GRIS);
        ...
        auto2.setColor(Automovil.COLOR_AMARILLO);
        ...
        auto3.setColor(Automovil.COLOR_ROJO);
        auto3.setCilindrada(2.5);

        // creación de un objeto a partir de un constructor con tres argumentos
        Automovil auto4 = new Automovil("TVS","Apache 200 RTR 4 Válvulas", Automovil.COLOR_NEGRO);
        auto4.setCilindrada(200);

        // creación de un objeto a partir de un constructor con cuatro argumentos
        Automovil auto5 = new Automovil("TVS","Apache 180 RTR 2 Válvulas", Automovil.COLOR_AZUL, 180);

        // creación de un objeto a partir de un constructor con cinco argumentos
        Automovil auto6 = new Automovil("Nissan","Sentra", Automovil.COLOR_ROJO, 1.6,3);

        // creación de un objeto a partir de un constructor con todos los argumentos
        Automovil auto7 = new Automovil("TVS","Apache 160 RTR 2 Válvulas", Automovil.COLOR_NEGRO, 160);

        Automovil auto8 = new Automovil("TVS","Apache 160 RTR 2 Válvulas", Automovil.COLOR_BLANCO, 160);
